            ...
            <main className="max-w-7xl mx-auto pb-20 px-6 pt-32">
                ...
                <Section id="intro" title="Getting Started" icon={BookOpen}>
                    <div className="space-y-4 text-slate-300">
                        <p>
                            <span className="text-[#DC1FFF] font-bold">CAPs</span> is an innovative decentralized application (DApp) designed for seamless payroll management using blockchain technology powered by Solana&apos;s Rust programming language.
                        </p>
                        <p>
                            ...
                            <div className="overflow-x-auto rounded-lg border border-slate-700">
                                <table className="w-full text-sm text-left text-slate-300">
                                    ...
                                    <tbody className="divide-y divide-slate-700">
                                        ...
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Add worker</td><td className="px-6 py-4 font-mono text-[#00FFA3]">Add worker 6yQ... to Google salary 3.5 SOL</td><td className="px-6 py-4">Worker added</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Fund treasury</td><td className="px-6 py-4 font-mono text-[#00FFA3]">Fund Amazon with 20 SOL</td><td className="px-6 py-4">SOL transferred</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Pay everyone</td><td className="px-6 py-4 font-mono text-[#00FFA3]">Process payroll for Microsoft</td><td className="px-6 py-4">All workers paid</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Withdraw</td><td className="px-6 py-4 font-mono text-[#00FFA3]">Withdraw 8 SOL from Meta</td><td className="px-6 py-4">Sent to your wallet</td></tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div className="mt-12 grid md:grid-cols-4 gap-4">
                    {[
                        { label: 'Total Files', value: '48+' },
                        { label: 'Code Files', value: '38+' },
