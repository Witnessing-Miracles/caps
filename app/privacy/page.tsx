            ...
            content: (
                <div className="space-y-4 text-slate-300">
                    <p className="leading-relaxed">
                        CAPs is built from the ground up with privacy as a non-negotiable feature — not an afterthought.
                    </p>
            ...
            content: (
                <div className="text-slate-400 space-y-4">
                    ...
                    <p className="mt-6 p-4 bg-slate-800/50 rounded-lg border border-[#00FFA3]/30">
                        Questions? Reach out anytime: <a href="mailto:peile.wu.1990@gmail.com" className="text-[#00FFA3] hover:text-white underline">peile.wu.1990@gmail.com</a>
                    </p>
                </div>
            )
        },
        {
            ...
            content: (
                <p className="text-slate-400">
                    This policy was last updated on <strong>April 8, 2026</strong>. Will notify users of material changes via the app and GitHub.
                </p>
            )
        }
    ];
                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="text-center pt-12">
                        <p className="text-2xl font-bold bg-linear-to-r from-[#DC1FFF] to-[#00FFA3] bg-clip-text text-transparent">
                            Firmly safeguard users' privacy and security.
                        </p>
                    </div>
                </div>
            </section>
